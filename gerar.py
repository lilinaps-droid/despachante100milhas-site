  ...
  <div class="rodape-central">
    ...
    <div>
      ...
      <div class="aviso" style="margin-top:var(--e-5)">
        <strong style="color:#fff">Despachante credenciado — empresa privada de assessoria em documentação veicular.</strong><br>
        Não somos órgão público nem representamos o DETRAN. Somos despachantes credenciados e auxiliamos proprietários de veículos na regularização de documentação e na orientação junto aos órgãos competentes.
      </div>
    </div>
  </div>
  <div class="foot-fim">
